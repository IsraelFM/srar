...
exports.create = (req, res) => {
    // Validate request
    if (!req.body.year || !req.body.license_plate || !req.body.renavam || !req.body.brand || !req.body.user_id) {
...
exports.update = (req, res) => {
    ...
    Vehicle
        ...
        .catch(err => {
            res.status(500).send({
                message: err.message || "Error updating Vehicle to vehicle with id=" + id
            });
        });
};
